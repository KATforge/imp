...
def help ():
   ...
   console.out.print ("  imp pull                                  [muted]# fetch + integrate upstream, AI-resolve conflicts[/muted]")
   console.out.print ("  imp sync                                  [muted]# pull, rebase, push[/muted]")
   console.out.print ("  imp merge <branch>                        [muted]# merge a branch in, AI-resolve conflicts[/muted]")
   console.out.print ("  imp resolve                               [muted]# resume an in-progress merge or rebase[/muted]")
   ...
   console.out.print ("  imp collapse <version> --since <floor>    [muted]# fold several releases into one tag[/muted]")
   ...
   console.out.print ("  imp init [url]                            [muted]# bootstrap a git repo (init + remote + .gitignore)[/muted]")
   console.out.print ("  imp setup                                 [muted]# configure this repo's .imp (docs sync, changelog)[/muted]")
   console.out.print ("  imp config                                [muted]# configure AI provider and models[/muted]")
   console.out.print ("  imp docs                                  [muted]# sync prose docs against recent commits[/muted]")
