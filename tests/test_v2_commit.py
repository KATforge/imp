...
from imp_git import ai, commit_plan, git, identity, state
...
class TestCommitPlans:
   ...
   def test_plan_and_apply_create_a_root_commit (self, unborn_repo, monkeypatch):
      ...
      assert git.commit_parents ("HEAD") == []
   ...
   def test_amend_replaces_only_the_last_unpublished_commit (self, repo, monkeypatch):
      ...
      original_count = git.commit_count ()
      ...
      assert git.commit_count () == original_count
